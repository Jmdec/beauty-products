    ...
    <div className="flex flex-col min-h-screen bg-[#fdf8f8]">
      ...
      <main className="flex-1 overflow-hidden">
        ...
        <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden">
          ...
          {/* Decorative rings */}
          <div className="absolute top-8 right-8 w-56 h-56 rounded-full border border-pink-200/50" />
          <div className="absolute top-14 right-14 w-40 h-40 rounded-full border border-pink-100/40" />
          <div className="absolute bottom-8 left-8 w-24 h-24 rounded-full border border-rose-200/40" />

          {/* Diagonal line */}
          <div
            className="absolute top-0 right-[35%] w-px h-full bg-gradient-to-b from-transparent via-pink-200/50 to-transparent"
          ...
          <div className="relative z-10 container mx-auto px-4 text-center max-w-3xl">
            ...
            <h1
              className="text-6xl sm:text-7xl lg:text-8xl font-light text-transparent bg-clip-text leading-[1.05] mb-6"
              style={{
            ...
            <p
              className="text-lg text-rose-900/50 font-light"
              style={{ fontFamily: "'DM Sans', sans-serif" }}
            >
        ...
        <section className="py-20 relative">
          <div className="absolute right-0 top-0 w-[400px] h-full bg-gradient-to-l from-pink-100/30 to-transparent pointer-events-none" />
                    ...
                    >
                      ...
                      <div>
                        ...
                        {item.href ? (
                          <a
                            href={item.href}
                            className="text-rose-900/60 font-light hover:text-pink-500 transition-colors duration-200"
                            style={{ fontFamily: "'DM Sans', sans-serif" }}
                          >
                            {item.value}
                          </a>
                          ...
                          <p
                            className="text-rose-900/60 font-light"
                            style={{ fontFamily: "'DM Sans', sans-serif" }}
                          >
                            {item.value}
                          </p>
